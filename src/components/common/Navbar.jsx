...
const Navbar = () => {
    ...
    return (
        <div ref={navRef} className=" fixed top-0 left-0 z-[999] w-full px-[5rem] font-NeueMontrealRegular py-[1rem] bg-black bg-opacity-20 backdrop-blur-md text-white flex items-end justify-between ">
            <div className="" >
            ...
            <ul className="flex items-center gap-[1.6rem]" >
                {
                    ["Services", "Our Work", "About us", "Insights", "Contact us"].map((elem, index) => (
                        <li key={index} className={` cursor-pointer text-[1rem] ${ index === 3 && 'mr-[10rem]'}`} >{elem}</li>
                    ))
                }
            </ul>
        </div>
